...
<form method="post">
	<table align = "center">
		...
		<tr>
			<td><input type="text" name="category" placeholder="Example:PHP/CSS/HTML"></td>
		</tr>
		...
		<tr>
		<td>
		<textarea name="question" rows="8" placeholder="Describe your problem or question"></textarea>
		</td>
		</tr>
		
		<tr>
		<td><input type="file" accept="image/*" class="upload-box"><td>
		</tr>
